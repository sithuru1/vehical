...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $vehicle = htmlspecialchars($_POST['van_name']);
        ...
        // Get daily rate
        $stmt = $pdo->prepare("SELECT daily_rate FROM vans WHERE 
                              model = ? OR 
        ...
        $stmt = $pdo->prepare("INSERT INTO van_booking 
  ...
  <nav class="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 w-[95%] max-w-5xl rounded-2xl backdrop-blur-md bg-white/80 shadow-xl">
    <div class="flex flex-col">
      ...
      <div class="hidden md:flex md:items-center md:justify-center md:space-x-8 md:py-3">
        ...
        <a href="#container" class="text-black hover:text-yellow-700 font-medium">Vans</a>
     ...
     <div id="mobile-menu" class="hidden flex flex-col items-center space-y-4 px-6 py-4 text-center md:hidden rounded-b-2xl bg-white/60 backdrop-blur-lg">
       ...
       <a href="#container" class="text-black hover:text-yellow-700 font-medium block">Vans</a>
       <a href="home.php#vehicles" class="text-black hover:text-yellow-700 font-medium">Vehicles</a> 
    ...
    <section class="relative h-[80vh] min-h-[500px] max-h-[800px] bg-gray-900 text-white overflow-hidden">
        ...
        <div class="absolute inset-0 z-0">
            <!-- Van Rental Image -->
            <img src="images/vans/van5.jpg" 
                 alt="Van rental service in Sri Lanka" 
                 class="w-full h-full object-cover blur-sm md:blur-none lg:blur-sm scale-105 brightness-90"
                 loading="lazy">
            <!-- Gradient Overlay -->
        ...
        <div class="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
            <div class="max-w-4xl px-4 sm:px-6">
                <h1 class="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 md:mb-6 text-white drop-shadow-xl">
                    Premium Van Rentals in Sri Lanka
                </h1>
                <p class="text-xl sm:text-2xl md:text-3xl max-w-2xl mx-auto text-gray-100 drop-shadow-md mb-8">
                    Spacious and comfortable vans for your group travels
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <button id="browse-vans" class="px-8 py-3 bg-blue-600 hover:bg-blue-700 rounded-lg text-lg font-semibold text-white transition-all duration-300 transform hover:scale-105 shadow-lg">
                        Browse Vans
                    </button>
                    <button id="special-offers" class="px-8 py-3 bg-white/10 hover:bg-white/20 border border-white/30 rounded-lg text-lg font-semibold text-white transition-all duration-300 transform hover:scale-105 shadow-lg">
                        Special Offers
                    </button>
                </div>
            </div>
    ...
    <section id="container" class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 id="van-section-title" class="text-3xl font-bold text-center mb-12">Our Van Fleet</h2>
            <div id="van-container" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Van 1 -->
                <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div class="relative h-48 overflow-hidden">
                        <img src="images/vans/van1.jpg" 
                             alt="Toyota Hiace" class="w-full h-full object-cover">
                        <div class="absolute top-2 right-2 bg-yellow-500 text-black px-2 py-1 rounded text-sm font-bold">Popular</div>
                    </div>
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-2">
                            <h3 class="text-xl font-bold">Toyota Hiace</h3>
                            <span class="text-lg font-bold text-yellow-600">LKR 15,000/day</span>
                        </div>
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div class="relative h-48 overflow-hidden">
                        <img src="images/vans/van2.jpg" 
                             alt="Nissan Caravan" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-2">
                            <h3 class="text-xl font-bold">Nissan Caravan</h3>
                            <span class="text-lg font-bold text-yellow-600">LKR 14,000/day</span>
                        </div>
                        <div class="flex items-center text-gray-600 mb-4">
                            <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div class="relative h-48 overflow-hidden">
                        <img src="images/vans/van3.jpg" 
                             alt="Mitsubishi Delica" class="w-full h-full object-cover">
                        <div class="absolute top-2 right-2 bg-yellow-500 text-black px-2 py-1 rounded text-sm font-bold">4WD</div>
                    </div>
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-2">
                            <h3 class="text-xl font-bold">Mitsubishi Delica</h3>
                            <span class="text-lg font-bold text-yellow-600">LKR 16,500/day</span>
                        </div>
                        <div class="flex items-center text-gray-600 mb-4">
                            <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div class="relative h-48 overflow-hidden">
                        <img src="images/vans/van4.jpg" 
                             alt="Toyota Noah" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-2">
                            <h3 class="text-xl font-bold">Toyota Noah</h3>
                            <span class="text-lg font-bold text-yellow-600">LKR 13,000/day</span>
                        </div>
                        <div class="flex items-center text-gray-600 mb-4">
                            <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
                        ...
                        <ul class="space-y-2 mb-6">
                            ...
                            <li class="flex items-center">
                                ...
                                <span>Dual Air Conditioning</span>
                            </li>
                            <li class="flex items-center">
                                <svg class="w-5 h-5 mr-2 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                ...
                <!-- Special Offer Van 1 (Hidden by default) -->
                <div id="special-offer-1" class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 hidden">
                    <div class="relative h-48 overflow-hidden">
                        <img src="images/vans/van6offer.jpg" 
                             alt="Toyota Hiace Special Offer" class="w-full h-full object-cover">
                        <div class="offer-badge">Special Offer</div>
                    </div>
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-2">
                            <h3 class="text-xl font-bold">Toyota Hiace (Special)</h3>
                            <div>
                                <span class="text-lg font-bold text-gray-400 line-through mr-2">LKR 15,000</span>
                ...
                <!-- Special Offer Van 2 (Hidden by default) -->
                <div id="special-offer-2" class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 hidden">
                    <div class="relative h-48 overflow-hidden">
                        <img src="images/vans/van7offer.jpg" 
                             alt="Mitsubishi Delica Special Offer" class="w-full h-full object-cover">
                        <div class="offer-badge">Special Offer</div>
                    </div>
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-2">
                            <h3 class="text-xl font-bold">Mitsubishi Delica (Special)</h3>
                            <div>
                                <span class="text-lg font-bold text-gray-400 line-through mr-2">LKR 16,500</span>
                                <span class="text-lg font-bold text-red-600">LKR 14,000/day</span>
                            </div>
                        </div>
                        <div class="flex items-center text-gray-600 mb-4">
                            <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div id="booking-modal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center p-2 sm:p-4">
    <div class="bg-white rounded-lg max-w-md w-full mx-2 p-4 sm:p-6 overflow-y-auto" style="max-height: 90vh;">
        <div class="flex justify-between items-center mb-4">
            <h3 class="text-lg sm:text-xl font-bold">Book Your Van</h3>
    ...
    <input type="hidden" id="van_id" name="van_id">
    
    <div>
        <label class="block text-gray-700 text-sm sm:text-base mb-1">Van Model</label>
        <input type="text" name="van_name" id="van_name" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="cars.html" class="text-gray-400 hover:text-yellow-400">Cars</a></li>
                        <li><a href="vans.html" class="text-gray-400 hover:text-yellow-400">Vans</a></li>
                        <li><a href="bus.html" class="text-gray-400 hover:text-yellow-400">Buses</a></li>
                    <li><a href="bikes.html" class="text-gray-400 hover:text-yellow-400">Bikes</a></li>
                    </ul>
                </div>
                <div>
    ...
    <script>
        ...
        bookButtons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                if (bookingModal) {
                    const inputField = bookingModal.querySelector('input[type="text"]');
                    if (inputField) inputField.value = vehicleName;
        ...
        if (closeModal && bookingModal) {
            ...
            const specialOffersBtn = document.getElementById('special-offers');
            const browseVansBtn = document.getElementById('browse-vans');
            const vanContainer = document.getElementById('van-container');
            const vanSectionTitle = document.getElementById('van-section-title');
            const regularVans = Array.from(vanContainer.children).filter(van => 
                !van.id.includes('special-offer')
            );
            const specialOfferVans = [
                document.getElementById('special-offer-1'),
                document.getElementById('special-offer-2')
            ];
            
            if (specialOffersBtn) {
                specialOffersBtn.addEventListener('click', function(e) {
                    e.preventDefault();
                    
                    // Hide all regular vans
                    regularVans.forEach(van => van.classList.add('hidden'));
                    
                    // Show special offer vans
                    specialOfferVans.forEach(van => van.classList.remove('hidden'));
                    
                    // Update section title
                    if (vanSectionTitle) {
                        vanSectionTitle.textContent = 'Special Offers';
                    }
                    
                    // Adjust grid layout for 2 offers
                    vanContainer.classList.remove('lg:grid-cols-3');
                    vanContainer.classList.add('lg:grid-cols-2');
                });
            }
            
            if (browseVansBtn) {
                browseVansBtn.addEventListener('click', function(e) {
                    e.preventDefault();
                    
                    // Show all regular vans
                    regularVans.forEach(van => van.classList.remove('hidden'));
                    
                    // Hide special offer vans
                    specialOfferVans.forEach(van => van.classList.add('hidden'));
                    
                    // Reset section title
                    if (vanSectionTitle) {
                        vanSectionTitle.textContent = 'Our Van Fleet';
                    }
                    
                    // Reset grid layout
                    vanContainer.classList.remove('lg:grid-cols-2');
                    vanContainer.classList.add('lg:grid-cols-3');
                });
            }
        });
    </script>
