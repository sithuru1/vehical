...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $vehicle = htmlspecialchars($_POST['bus_name']);
        ...
        // Get daily rate
        $stmt = $pdo->prepare("SELECT daily_rate FROM buses WHERE 
                              model = ? OR 
        ...
        $stmt = $pdo->prepare("INSERT INTO bus_booking 
  ...
  <nav class="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 w-[95%] max-w-5xl rounded-2xl backdrop-blur-md bg-white/80 shadow-xl">
    <div class="flex flex-col">
      ...
      <div class="hidden md:flex md:items-center md:justify-center md:space-x-8 md:py-3">
        ...
        <a href="#container" class="text-black hover:text-yellow-700 font-medium">Buses</a>
     ...
     <div id="mobile-menu" class="hidden flex flex-col items-center space-y-4 px-6 py-4 text-center md:hidden rounded-b-2xl bg-white/60 backdrop-blur-lg">
       ...
       <a href="#container" class="text-black hover:text-yellow-700 font-medium block">Buses</a>
       <a href="home.php#vehicles" class="text-black hover:text-yellow-700 font-medium">Vehicles</a> 
    ...
    <section class="relative h-[80vh] min-h-[500px] max-h-[800px] bg-gray-900 text-white overflow-hidden">
        ...
        <div class="absolute inset-0 z-0">
            <!-- Bus Rental Image -->
            <img src="images/bus/busmain.jpg" 
                 alt="Bus rental service in Sri Lanka" 
        ...
        <div class="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
            <div class="max-w-4xl px-4 sm:px-6">
                <h1 class="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 md:mb-6 text-white drop-shadow-xl">
                    Premium Bus Rentals in Sri Lanka
                </h1>
                <p class="text-xl sm:text-2xl md:text-3xl max-w-2xl mx-auto text-gray-100 drop-shadow-md mb-8">
                    Comfortable group travel for your next adventure
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <button id="browse-buses-btn" class="px-8 py-3 bg-blue-600 hover:bg-blue-700 rounded-lg text-lg font-semibold text-white transition-all duration-300 transform hover:scale-105 shadow-lg">
                        Browse Buses
                    </button>
                    <button id="group-discounts-btn" class="px-8 py-3 bg-white/10 hover:bg-white/20 border border-white/30 rounded-lg text-lg font-semibold text-white transition-all duration-300 transform hover:scale-105 shadow-lg">
                        Group Discounts
                    </button>
                </div>
            </div>
   ...
   <!-- Single Wave Border Bottom Only -->
      <div id="container" class="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] z-10 rotate-180">
    ...
    <!-- Regular Bus Listing -->
    <section id="regular-buses" class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-12">Our Bus Fleet</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div class="relative h-48 overflow-hidden">
                        <img src="images/bus/Luxury.jpg" 
                             alt="Luxury Coach" class="w-full h-full object-cover">
                        <div class="absolute top-2 right-2 bg-yellow-500 text-black px-2 py-1 rounded text-sm font-bold">Popular</div>
                    </div>
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-2">
                            <h3 class="text-xl font-bold">Luxury Coach</h3>
                            <span class="text-lg font-bold text-yellow-600">LKR 35,000/day</span>
                        </div>
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div class="relative h-48 overflow-hidden">
                        <img src="images/bus/mini.avif" 
                             alt="Mini Bus" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-2">
                            <h3 class="text-xl font-bold">Mini Bus</h3>
                            <span class="text-lg font-bold text-yellow-600">LKR 25,000/day</span>
                        </div>
                        <div class="flex items-center text-gray-600 mb-4">
                            <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div class="relative h-48 overflow-hidden">
                        <img src="images/bus/scholl.jpg" 
                             alt="School Bus" class="w-full h-full object-cover">
                        <div class="absolute top-2 right-2 bg-yellow-500 text-black px-2 py-1 rounded text-sm font-bold">Economy</div>
                    </div>
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-2">
                            <h3 class="text-xl font-bold">School Bus</h3>
                            <span class="text-lg font-bold text-yellow-600">LKR 20,000/day</span>
                        </div>
                        <div class="flex items-center text-gray-600 mb-4">
                            <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
    ...
    <!-- Group Discounts Section (Hidden by default) -->
    <section id="group-discounts" class="py-16 bg-gray-100 discount-section">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-12">Special Group Discounts</h2>
            <p class="text-center text-lg mb-8 max-w-2xl mx-auto">
                Get exclusive discounts when booking multiple buses for your group travel. Perfect for weddings, corporate events, school trips, and pilgrimages.
            </p>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div class="relative h-48 overflow-hidden">
                        <img src="images/bus/Luxury.jpg" 
                             alt="Luxury Coach Group Discount" class="w-full h-full object-cover">
                        <div class="absolute top-2 right-2 bg-red-500 text-white px-2 py-1 rounded text-sm font-bold">25% OFF</div>
                    </div>
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-2">
                            <h3 class="text-xl font-bold">Luxury Coach (Group)</h3>
                            <div class="text-right">
                                <span class="text-lg font-bold text-red-600">LKR 26,250/day</span>
                                <span class="block text-sm text-gray-500 line-through">LKR 35,000/day</span>
                            </div>
                        </div>
                        <div class="flex items-center text-gray-600 mb-4">
                            <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button class="w-full bg-red-500 hover:bg-red-600 text-white font-bold py-3 px-4 rounded-lg transition duration-200 book-now-btn">
                            Get Group Discount
                        </button>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div class="relative h-48 overflow-hidden">
                        <img src="images/bus/mini.avif" 
                             alt="Mini Bus Group Discount" class="w-full h-full object-cover">
                        <div class="absolute top-2 right-2 bg-red-500 text-white px-2 py-1 rounded text-sm font-bold">20% OFF</div>
                    </div>
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-2">
                            <h3 class="text-xl font-bold">Mini Bus (Group)</h3>
                            <div class="text-right">
                                <span class="text-lg font-bold text-red-600">LKR 20,000/day</span>
                                <span class="block text-sm text-gray-500 line-through">LKR 25,000/day</span>
                            </div>
                        </div>
                        <div class="flex items-center text-gray-600 mb-4">
                            <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section class="py-16 bg-gray-100">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-12">Why Choose Our Bus Rentals?</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white p-6 rounded-lg shadow-md text-center">
                    ...
                    <p class="text-gray-600">All our buses come with comprehensive insurance coverage for your peace of mind.</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-md text-center">
                    <div class="flex justify-center mb-4">
                        <svg class="w-12 h-12 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-gray-600">We offer the best rates for bus rentals with no hidden charges.</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-md text-center">
                    <div class="flex justify-center mb-4">
                        <svg class="w-12 h-12 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 class="text-xl font-bold mb-2">Flexible Payment</h3>
                    <p class="text-gray-600">Multiple payment options including cash, credit cards, and bank transfers.</p>
                </div>
            </div>
        </div>
    </section>
...
<div id="booking-modal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center p-2 sm:p-4">
    <div class="bg-white rounded-lg max-w-md w-full mx-2 p-4 sm:p-6 overflow-y-auto" style="max-height: 90vh;">
        <div class="flex justify-between items-center mb-4">
            <h3 class="text-lg sm:text-xl font-bold">Book Your Bus</h3>
    ...
    <div>
        <label class="block text-gray-700 text-sm sm:text-base mb-1">Bus Model</label>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Show modal with selected vehicle name - UPDATED VERSION
    bookButtons.forEach(button => {
        button.addEventListener('click', function() {
            const vehicleName = this.closest('.bg-white')?.querySelector('h3')?.textContent || '';
            if (bookingModal) {
                const inputField = bookingModal.querySelector('input[name="bus_name"]');
        ...
        button.addEventListener('click', function() {
            ...
            if (card) {
                ...
                const inputField = document.getElementById('vehicle-field') || 
                                  document.querySelector('input[name="bus_name"]');
                if (inputField) inputField.value = vehicleName.trim();
            }
        });
    });
    ...
    // Initialize modals as hidden (in case they're visible before JS loads)
